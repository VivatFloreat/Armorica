...
resourcestring
  ...
  SOKButton = 'V redu';
  SCancelButton = 'Opusti';
  SYesButton = '&Da';
  SNoButton = '&Ne';
  SHelpButton = '&Pomoè';
  SCloseButton = '&Zapri';
  SIgnoreButton = '&Prezri';
  SRetryButton = '&Ponovi';
  SAbortButton = 'Opusti';
  SAllButton = '&Vse';
  ...
  SMsgDlgWarning = 'Opozorilo';
  SMsgDlgError = 'Napaka';
  SMsgDlgInformation = 'Info';
  SMsgDlgConfirm = 'Potrdi';
  SMsgDlgYes = '&Da';
  SMsgDlgNo = '&Ne';
  SMsgDlgOK = 'V redu';
  SMsgDlgCancel = 'Opusti';
  SMsgDlgHelp = '&Pomoè';
  SMsgDlgHelpNone = 'Pomoè ni na voljo';
  SMsgDlgHelpHelp = 'Pomoè';
  SMsgDlgAbort = '&Opusti';
  SMsgDlgRetry = '&Ponovi';
  SMsgDlgIgnore = '&Prezri';
  SMsgDlgAll = '&Vse';
  SMsgDlgNoToAll = 'N&e za vse';
  SMsgDlgYesToAll = 'Da za &Vse';
  ...
  srUnknown = '(Unknown)';
  srNone = '(None)';
  SOutOfRange = 'Vrednost mora biti med %d in %d';
